...
function descextra( _p, _o, po )
   ...
   desc=add_desc(desc, _("Energy Capacity"), unit_energy, "+525", "+575", "#g", nomain, nosec)
   desc=add_desc(desc, _("Energy Regeneration"), unit_power, "+17", "+19", "#g", nomain, nosec)
   desc=add_desc(desc, _("Shield Capacity"), unit_energy, "+330", "+70", "#g", nomain, nosec)
   desc=add_desc(desc, _("Shield Regeneration"), unit_power, "+6.5", "+1", "#g", nomain, nosec)
