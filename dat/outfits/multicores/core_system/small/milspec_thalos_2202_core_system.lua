...
function descextra( _p, _o )
   ...
   desc=desc.."#r"
   add_desc( _("Ship Mass"), naev.unit("mass"), "+12"," +58" )
   desc=desc.."#0"
   add_desc( _("CPU max"), "", "+24"," +66" )
   add_desc( _("Energy Capacity"), naev.unit("energy"), "+150"," +200" )
   add_desc( _("Energy Regeneration"), "", "+8"," +7" )
   add_desc( _("Shield Capacity"), naev.unit("energy"), "+180"," +45" )
   add_desc( _("Shield Regeneration"), "", "+6"," +1" )
