...
function descextra( _p, po )
   ...
   if po:get( "cpu_max")==380 then
      nosec=true
   elseif po:get( "cpu_max")==0 then
      nomain=true
   end
   add_desc( _("CPU max"), "", "+380"," _" , "#g", nomain,nosec)
   add_desc( _("Energy Capacity"), naev.unit("energy"), "+1760"," _", "#g", nomain,nosec)
   add_desc( _("Energy Regeneration"), "", "+35"," _" , "#g", nomain,nosec)
   add_desc( _("Shield Capacity"), naev.unit("energy"), "+500"," _", "#g", nomain,nosec)
   add_desc( _("Shield Regeneration"), "", "+9"," _" , "#g", nomain,nosec)
