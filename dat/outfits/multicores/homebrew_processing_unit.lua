...
function descextra( _p, _po )
   ...
   desc=desc.."#g"
   desc=add_desc(desc, _("CPU max"), "", "+10", "_" , "#g", nomain, nosec)
   desc=add_desc(desc, _("Energy Capacity"), naev.unit("energy"), "+140", "_", "#g", nomain, nosec)
   desc=add_desc(desc, _("Energy Regeneration"), "", "+7", "_" , "#g", nomain, nosec)
   desc=add_desc(desc, _("Shield Capacity"), naev.unit("energy"), "+130", "_", "#g", nomain, nosec)
   desc=add_desc(desc, _("Shield Regeneration"), "", "+4", "_" , "#g", nomain, nosec)
   desc=add_desc(desc, _("Detection"), "", "+15", "_" , "#g", nomain, nosec)
