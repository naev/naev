...
function theFunBegins()
   ...
   preacher=pilot.add("Sirius Reverence", "Sirius", curr, nil, "sirius_norun")
   preacher:setHilight()
   ...
   followers = addShips(1, followers, "Sirius", curr, nil, "sirius_norun") -- The table now contains pilots, not ship names.
   ...
   sirianFollowers = addShips(1, sirianFollowerList, "Sirius", curr, nil, "sirius_norun") -- The table now contains pilots, not ship names.
