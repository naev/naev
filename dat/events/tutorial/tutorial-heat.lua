...
title1 = _("Tutorial: Heat")
message1 = _([[Welcome to the heat tutorial.
...
message3 = _([[As you probably saw, your weapons started shooting slightly off to the sides when they heated up. This can be very problematic in combat, so always keep an eye on your weapons' heat levels.
...
message4 = _([[So that's heat in a nutshell, right? As it turns out, there's more to it. We just learned that weapons cool down by transferring heat into the ship hull. But what if the ship hull gets hot?
...
message5 = _([[As you can see, having a hot ship is very inconvenient. It would be nice if ships could lose their heat somehow, wouldn't it? Fortunately, there are some ways to lose heat.
...
message6 = _([[Every ship has the ability to go into a special cooling mode called Active Cooldown. When in Active Cooldown, ships rapidly lose their heat. By the end of the cooldown cycle, the ship and all its outfits will have cooled to the galactic base temperature.
...
message7 = _([[You are now in Active Cooldown mode. You will see a progress bar above your ship. It is slowly draining. When the bar is completely empty, your ship will have cooled down. Don't touch any of the controls, or Active Cooldown will be canceled and you will have to restart it.
...
message8 = _([[Well done! You have completed the Active Cooldown cycle, and your ship is as cool as the space around it.
...
message9 = _([[You now know about the important heat mechanics in the game. As a final tip, remember that the heat rules apply to other ships just as much as they do to you. Dodging an enemy until his weapons overheat is a valid tactic!

Congratulations! This concludes the heat tutorial.]])

wepomsg = _([[Use %s to fire your weapons (%ds remaining)]])
waitomsg = _([[Observe your ship's heat (%ds remaining)]])
coolomsg = _([[Enter Active Cooldown (%s while braking or stopped)]])
