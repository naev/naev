...
function ship_buy( shipname )
   ...
   elseif s:time_mod() > 1 and not var.peek( "tut_timedil" ) then
      ...
      sai(_([["In general, due to the low manoeuvrability of large ships, you should consider using turret weapons and/or fighter bays for self defence. They allow you to worry less about aiming and more about getting jobs done. Turrets rely heavily on their tracking values. '#oMinimum Tracking#0' refers to the '#oEvasion#0' value of a target ship at which the turret will not be able to track. On the other hand, if the target ship is above the '#oOptimal Tracking#0', your turrets will be able to perfectly track them. It is best to try out different turrets and see what feels best for your ship."]]))
      vn.done( tut.shipai.transition )
      vn.run()
