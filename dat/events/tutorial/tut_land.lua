   ...
   elseif tbroad == "License" then
      ...
      elseif o == outfit.get("Light Combat Vessel License") and not var.peek( "tut_lic_lightcom" ) then
         text = {
            ...
            _([["#oInterceptors#0 are the lightest of the three with limited slots, but low mass and high maneuverability. #oFighters#0 and #oBombers#0 are heavier but still very agile, with fighters specialised in closer combat with small craft, while bombers are known to carry torpedoes that can ravage even the largest of battleships."]]),
