...
local function updater090 ()
   ...
   if not var.peek( "tut_update" ) then
      ...
      -- - outfit balance
      -- - safe lanes
      vn.na("Suddenly, a hologram materialises in front of you.")
      sai(fmt.f(_([["Hello there {playername}! I'm your Ship AI. Up until now I've been resident in your ship controlling your Autonav and other functionality, but with new updates, I can now materialises and communicate directly to you as a hologram."
