...
loyal_text3 = _([["House Dvaered has been built in respect of this ethic of life and death, that is taught to all children around all worlds in Dvaered space. You did not recieve such an education and however, you passed the loyalty test. This means that Dvaered High Command can trust you. As a proof of this trust, I can reveal you what many among the army know, but was never revealed to non-Dvaered.
   ...
   "A few decaperiods ago, General Klank has been promoted as second class general, with the task to organize this invasion. The first invasion plan that had been proposed to him was letting huge freedom to the warlord in order to choose which planet to invade and how to proceed. However, contrary to the other generals, Klank soon understood that such a disorganized invasion, with inevitably battle between warlords, would take for several periods, with a huge risk to end up bogged down and vulnerable to attacks on the other fronts."]])
