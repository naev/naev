...
<event name="Division Marius">
  ...
  <chance>10</chance>
  <cond>false or player.misnDone("Dvaered Ballet") and not (player.misnDone("Dvaered Base") or player.misnActive("Dvaered Base") or player.misnDone("Dvaered Triathlon"))</cond>
  <flags>
   <unique />
  </flags>
  <notes>
