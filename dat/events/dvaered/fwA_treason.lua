...
function reaction()
   ...
   "A few decaperiods ago, General Klank had been promoted as second class general, with the task to organise this invasion. The first invasion plan that had been proposed to him was giving free rein to each warlord, allowing them to choose which planet to invade and how to proceed. However, contrary to the other generals, Klank soon realised that such a disorganised invasion, with inevitable battles between warlords, would take several periods, with a huge risk of ending up bogged down and vulnerable to attacks on other fronts."]]))
