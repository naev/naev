...
local msg_lore = {
   ...
   _([["The FLF used to be a pacifist movement before it was outlawed and radicalized. Now they're so obsessed with eliminating the Dvaered that they even bomb and attack civilian targets!"]]),
   ...
   _([["The Dvaered economic crisis also affects the Frontier. Lots of young people join the FLF or Dreamer Clan pirates just to be able to survive."]]),
}

--local msg_tip = {}

local msg_cond = {
   { npc.test_misnDone("Destroy the FLF base!"), _([["I heard that the Dvaered blew up a major FLF base. This makes me uncertain of the future of the Frontier."]]) },
