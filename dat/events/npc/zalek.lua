...
local msg_lore = {
   _([["The Soromid? Hah! We Za'lek are the only true scientists in this galaxy."]]),
   ...
   _([["House Za'lek is for researchers, run by researchers. Council members are chosen randomly and forced to fill their obligations to argue and decide about the future of House Za'lek. Lots of people complain, but this is the best way to avoid nepotism and corruption that is rampant in the Empire and other Houses!"]]),
