...
local articles = {
   ...
   --]]
   {
      header = N_([[Skull and Bones Improving]]),
   ...
   --]]
   {
      header = N_([[Draconis Favourite Plundering Space]]),
   ...
   {
      header = N_([[New Ships for Skull and Bones]]),
   ...
   --]]
   {
      header = N_([[Emperor Weaker Than Ever]]),
