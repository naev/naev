...
local articles = {
   ...
   --]]
   {
      header = N_([[Terraforming Emperor's Fist]]),
   ...
   {
      header = N_([[Bees Introduced to Emperor's Fist]]),
   ...
   --]]
   {
      header = N_([[Empire Keeping Traders Safe]]),
   ...
   {
      header = N_([[Nexus Contract Finalised]]),
   ...
   {
      header = N_([[Governor Helmer Jailed]]),
   ...
   {
      header = N_([[Imperial Council Opens Doors]]),
   ...
   {
      header = N_([[Remembering the Past]]),
