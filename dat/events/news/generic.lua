...
local articles = {
   ...
   {
      header = N_([[Sand Monster Caught On Tape]]),
   ...
   {
      header = N_([[New Handheld AI Debuts]]),
   ...
   {
      header = N_([[Experiment Produces Cold Fusion]]),
   ...
   --]]
   {
      header = N_([[Fullerton Reports Quarterly Loss]]),
   ...
   {
      header = N_([[Genetric Board Meets]]),
   ...
   --]]
   {
      header = N_([[Eyeteeth Back in Fashion]]),
   ...
   {
      header = N_([[Everyone Loves a SuperChimp]]),
   ...
   {
      header = N_([[Admiral's Ball a Triumph]]),
   ...
   {
      header = N_([[Amazing Survival Story]]),
   ...
   {
      header = N_([[The Best Spaceport Bars]]),
   ...
   {
      header = N_([[RIP: The Floating Vagabond]]),
   ...
   {
      header = N_([[Games for Young Pilots]]),
   ...
   {
      header = N_([[Former Pirate Writes Target Management Self-Help Book]]),
      body = function () fmt.f(
