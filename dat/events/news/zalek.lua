...
local articles = {
   ...
   },
   {
      ...
      desc = _([[A long renowned scientist arrested for using an unauthorized nuclear device to make toast. A three headed cat was attained from perpetrator's appartment and sent for further studies.]]),
   },
}
