...
local articles = {
   ...
   --]]
   {
      header = N_([[Drone Malfunctions at Record High]]),
   ...
   {
      header = N_([[New Funding Call for Antimatter Research]]),
   ...
   {
      header = N_([[Breakthrough in Spectral Lattice Crystal Amplifiers]]),
   ...
   {
      header = N_([[P versus NP Proof Proven False]]),
   ...
   --]]
   {
      header = N_([[New Startup to Harness Power of Nebula]]),
   ...
   --]]
   {
      header = N_([[Za'lek Leadership Committee Breaks Record Length]]),
   ...
   --]]
   {
      header = N_([[Altercation at Conference on Philosophy and Ethics]]),
   ...
   {
      header = N_([[Za'lek Citizen Arrested]]),
...
return function ()
   return "Za'lek", header, greeting, articles
end
