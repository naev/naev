...
- #oStealth#0 determines the distance at which the ship is undetected when in stealth mode"]]))
   ...
   sai(fmt.f(_([["You can check to see if your commodities or outfits are illegal from the info menu which you can open with {infokey}, and then looking at your ship outfits or commodities. Note that illegality is determined on a per-faction basis instead of globally."]])
