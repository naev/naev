...
function enter_bar ()
   ...
   if not lmisn.anyMissionActive( flf_missions ) then
    ...
    Benito clears her throat. "But I'm sure you can guess what your mission is. You need to join with the others in the fight against the incoming Empire ships. You have to destroy all of the ships. I will be here helping to man the station; our defenses are weak, but better than nothing."]]), {sys=emp_srcsys, player=player.name()} ) )
...
function land ()
   if planet.cur():faction() == faction.get("Thurion") then
    ...
    "Well met," she says. "I see you have made the right choice and survived the nebula. Very good."]]) )
      tk.msg( _("Welcome To the Nebula"), _([["I'm sure you're wondering who we are. We are the Thurion, a civilisation left over from one of the Empire's former secret projects. Have you met the Za'lek? The Collective? Those too were the Empire's "great projects", as were the now dead Proteron. But we were kept a lot more in the dark.
    ...
    Now, the Thurion have formed a secret civilisation. About half of the Thurion population is uploaded and Alicia was quick to extol the virtues of being uploaded, but also noted that you probably can't be uploaded due to a likelihood of excessive brain damage.
