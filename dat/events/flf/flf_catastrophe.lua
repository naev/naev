...
function timer_thurion ()
   ...
   tk.msg( _("Strange Happenings"), _([[Before you can even respond, the mysterious figure disappears. You detect no presences nearby, but you notice that your ship has been refuelled somehow! Odd. In any case, it looks like you have two choices: do you brave the dangers of the nebula and proceed to Metsys, or do you turn back now? The figure said that you can only make this decision once, so you'd better make sure it's the right one.]]) )
   player.refuel()
end
...
function land ()
   ...
   You affirm that you will keep the Thurion's secret safe. "Yes, welcome," Alicia says. "And do check out our bars and mission computers from time to time. We very well might have some missions for you in the future. In the meantime, buy yourself some nebula-resistant coating, and make yourself comfortable. You are our honoured guest and, I hope, the first of many outsiders to learn the wonders of our way of life."
   The guards then promptly but politely escort you back to your ship, which has been refuelled while you were gone. This should be an interesting experience....]]), {player=player.name()} ) )
