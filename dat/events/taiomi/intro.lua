...
function land ()
   ...
   if evt_state == 2 then
      ...
      d(_([["We have no choice but to take a large risk and try to move on. However, with only our strength we might not be able to pull it off before we are reverted to inert debris floating eternally in space."]]))
      d(_([["Although I hate to ask this of you, we do not have any alternative but to push forward. If you would be willing to help your plight, we would be very grateful. We can not offer much, but we may have ways of compensating your efforts. Please take your time to think it over and get in touch with me outside the ship if you are interested."]]))
