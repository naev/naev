...
system_events = {
   ...
   ["Gamma Polaris"] = {
      type = "distance",
      dist = 5000,
      pos  = planet.getS("Emperor's Wrath"):pos(),
   ...
   ["Za'lek"] = {
      type = "distance",
      dist = 5000,
      pos  = planet.getS("House Za'lek Central Station"):pos(),
   ...
   Ruadan = {
      type = "distance",
      dist = 5000,
      pos  = planet.getS("Ruadan Prime"):pos(),
   ...
   Dvaer = {
      type = "distance",
      dist = 5000,
      pos  = planet.getS("Dvaered High Command"):pos(),
   ...
   Limbo = {
      ...
      --type = "discover",
      --asset = planet.getS("Minerva Station"),
      type = "distance",
      dist = 5000,
      pos  = planet.getS("Minerva Station"):pos(),
      name = "disc_minerva",
