...
function neutralevent()
   ...
   local ntext = {
      ...
      _([[This derelict has really been beaten up badly. Most of the corridors are blocked by mangled metal, and your scans read depressurised compartments all over the ship. There's not much you can do here, so you decide to leave the derelict alone.]]),
      ...
      _([[You have attached your docking clamp to the derelict's airlock, but the door refuses to open. A few diagnostics reveal that the other side isn't pressurised. The derelict must have suffered hull breaches over the years. It doesn't seem like there's much you can do here.]]),
