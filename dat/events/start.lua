...
function create()
   ...
   intro.text()
   intro.image( lg.newImage(imgpath.."first_steps_into_space.webp") )
   ...
   intro.text()
   intro.image( lg.newImage(imgpath.."faster_than_light.webp") )
   ...
   intro.text()
   intro.image( lg.newImage(imgpath.."reign_of_daedris.webp") )
   ...
   intro.text()
   intro.image( lg.newImage(imgpath.."questions.webp") )
