local constants = {
   ...
   AUDIO_REF_DISTANCE   = 1e3, -- Was 500 until 0.13.0, but used inverse model before (now linear)
   AUDIO_MAX_DISTANCE   = 10e3, -- Was 25e3 until 0.13.0, but used the inverse model before (now linear)
