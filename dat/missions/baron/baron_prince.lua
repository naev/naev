...
text[6] = _([[You are swiftly escorted back to your ship. You didn't really get the chance to ask the Baron any questions, such as who these potential attackers are, how you're supposed to pay for the artefacts once you locate the sellers, or what you will get out of all this. You do, however, find an update to your galaxy map that shows the location of the sellers, as well as a list of names and portraits. It would seem that the only way to find out what you're dealing with is the hard way.]])
   
title[6] = _("What are you doing here?")

text[7] = _([[You have not yet collected and identified the genuine artefact. Buy the artefacts from the sellers and visit Flintley on %s (%s) to identify the real one.]])
...
title[9] = _("This is not the artefact you're looking for")
...
misn_desc[2] = _("Baron Sauterfeldt has tasked you with finding an ancient artefact, but he doesn't know exactly where to get it.")
...
sellerdesc = _("You spot a dodgy individual who matches one of the portraits in your ship's database. This must be one of the artefact sellers.")

buy = _("Buy the artefact (%s credits)")
nobuy = _("Don't buy the artefact")

nomoneytitle = _("Not enough money!")
nomoneytext = _("You can't currently afford to buy this artefact. You need %s credits.")

-- OSD stuff
osd_msg[1] = _("Fly to the %s system and dock with (board) Kahan Pinnacle")
osd_msg[2] = _("Buy the artefact and take it to Flintley")
osd_msg[3] = _("Take the artefact to Baron Sauterfeldt")
