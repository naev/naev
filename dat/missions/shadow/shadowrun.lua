...
function board()
   if mem.shadowrun == 2 then
    ...
    Then she is gone. You stare at the airlock hatch, then down at the credit chip in your hand, first marveling at the wealth it represents and then astonished to realise you can't remember how it got there.]]), {pnt=pnt}))
