...
if lang == "es" then
    ...
    message2 = [[    "Great! Now, since you've accepted this mission, you will see your mission objectives printed on the screen when in space. Your current objective will be higlighted in green. Your first objective is to fly to the abandoned station. Like I said, it's in the Cherokee system. You can find it with your overlay map.
