...
"For starters, if you haven't already, you should buy a #oLocal Map#0 that will help you get the directions to {sysname}. You can buy it at the main landing window or the outfiting window."]]),{sysname:name()}))
   vn.done( tutnel.nelly.transition )
