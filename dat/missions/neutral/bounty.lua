...
local reason_list = {
   ...
   ["Za'lek"] = {
      ...
      _([[ for conducting human experimentation without consent]]),
   ...
   ["Dvaered"] = {
      ...
      _([[ for conspiring against a Warlord]]),
   ...
   ["Soromid"] = {
      ...
      _([[ for disrespecting the sacrifices of the Soromid people]]),
      _([[ for spreading misinformation about the Soromid]]),
      _([[ for attempting to steal Soromid genetic data]]),
      _([[ for conspiring against the Soromid government]]),
      _([[ for hoarding resources meant for the Soromid people]]),
