...
He does a little jump to make a point. It does look like there is less buoyancy than before.]]))
   ...
   vn.na(_([[He leads you to the largest room at the base, which is the not very elegant cafeteria. He opens the door, and you are greeted by a myriad of faces, some which you recognize as colonists you helped bring over to Antlejos V from different parts of the galaxy. A cheer erupt from the crowd as you go to the centre of the room.]]))
   vn.na(_([[Verner almost slips when he jumps onto a table, likely not entirely used to the new gravity, and then helps you up. People start pouring and sharing foul smelling drinks, but Verner hands you a glass with something that smells much better and winks at you. After a bit it seems like everyone has got their drinks, and Verner directs himself to the crowd.]]))
   ...
   news.add{
      {
         ...
         date_to_rm = time.cur()+time.new(0,20,0),
      },
   }
