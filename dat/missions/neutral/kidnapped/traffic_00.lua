...
function land1()
   if spob.cur() == pnt1 and not mem.eavesdropped1 and not mem.eavesdropped2 then
      mem.bar1pir1 = misn.npcAdd("firstpirates", _("Pirate"), portrait.getMale("Pirate"), pir1_desc)
      mem.bar1pir2 = misn.npcAdd("firstpirates", _("Pirate"), portrait.get("Pirate"), pir1_desc)
   end
end

function land2()
   if spob.cur() == pnt2 and mem.eavesdropped1 and not mem.eavesdropped2 then
      mem.bar2pir1 = misn.npcAdd("secondpirates", _("Pirate"), portrait.get("Pirate"), pir2_desc)
      mem.bar2pir2 = misn.npcAdd("secondpirates", _("Pirate"), portrait.get("Pirate"), pir2_desc)
   end
end
