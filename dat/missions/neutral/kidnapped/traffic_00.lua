...
title[4] = _("The Dirt")
text[4] = _([[You don't even bother sitting down too close to these two pirates, considering they are talking as loudly as they are. It doesn't take too much listening before you get exactly what you need as one of the pirates is telling his recent tales to the other,
...
declinetext = _([[You can hear that the the man is quite disappointed as he says, "I'm sure you have a good reason not to want to help us, perhaps you have something else more pressing..." Before the comm is cut you can hear the woman beginning to sob and the man consoling her.]])

failedtitle = _("You killed the children")
failedtext = _([[Having just destroyed the kidnappers, you also just killed the children as well. As you sit there in space, with your head against the dash, a tear rolls down your cheek as you think of the parents and how their children are forever stolen from them. If only you could rewind and try again; you know the next time you would be more cautious. If only it were so easy...]])
