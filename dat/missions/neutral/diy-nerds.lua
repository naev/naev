...
if lang == "es" then
   ...
   title[3] = "Happy nerds"
   text[3] = [["Good job, %s," Mia compliments you upon arrival. "We'll now go win the competition and celebrate a bit. You better stay in the system. We will hail you in about 4-5 hours so you can pick us up an' bring us back to %s."
   ...
   text[7] = [[Your comm link comes up again. It is the nerds, whom you'd almost forgotten. You hear Mia's voice: "Hey, what are you waiting for? You'd better be here in the next hour, or we'll get another pilot!"]]
   ...
   title[15] = "The End"
   text[15] = [["It won't take longer than half an hour," Mia informs you. You stand by as the nerds start to mod their box. As they are going for it, you wonder if they're actually wrecking it and you'll maybe be left with a piece of worthless junk.
   ...
   -- stage 2
   textosd[4] = "You are to wait a few hours until hailed by the nerds for their return trip."
...
function create ()
   misn.setNPC( "Young People", "neutral/unique/mia" )
