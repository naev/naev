...
ab_ratio = [0.0, 0.15, 0.2, 0.6, 0.6, 0.65, 0.9, 0.9, 0.9]
...
for ra, l, c, ab in zip(race, length*3, configs, ab_ratio):
   total = {
      'speed': 0, 'accel': 0,
   ...
   print(s, '->', '\033[36m' + str(round(final)) + '\033[m')
   print(ra + ':','\033[36;1m' + fmt_tim(l/final) + '\033[m')
