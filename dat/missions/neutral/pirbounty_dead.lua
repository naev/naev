...
if lang == "es" then
   ...
   subdue_text[5] = "Getting past this ship's security was surprisingly easy. Didn't %s know that " .. { "he", "she" }[rnd.rnd( 1, 2 )] .. " was wanted?"
   ...
   pay_kill_text[3] = "The officer seems pleased that %s is finally dead. " .. { "He", "She" }[rnd.rnd( 1, 2 )] .. " thanks you and promptly hands you your pay."
   pay_kill_text[4] = "The paranoid-looking officer takes you into a locked room, where he quietly verifies the death of %s. " .. { "He", "She" }[rnd.rnd( 1, 2 )] .. " then pays you and sends you off."
   pay_kill_text[5] = "When you ask the officer for your bounty on %s, " .. { "he", "she" }[rnd.rnd( 1, 2 )] .. " sighs, leads you into his office, goes through some paperwork, and hands you your pay, mumbling something about how useless the bounty system is."
   ...
   pay_capture_text[2] = "The officer seems to think your decision to capture %s alive was insane. " .. { "He", "She" }[rnd.rnd( 1, 2 )] .. " carefully takes the pirate off your hands, taking precautions you think are completely unnecessary, and then hands you your pay"
   ...
   pay_capture_text[5] = "The officer you greet gives you a puzzled look when you tell " .. { "him", "her" }[rnd.rnd( 1, 2 )] .. " you captured %s alive, but nonetheless takes the pirate off of your hands and hands you your pay."
