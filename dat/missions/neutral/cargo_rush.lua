...
function create()
   ...
   car.setDesc( fmt.f( misn_desc[mem.tier], {cargo=mem.cargo, amount=fmt.tonnes(mem.amount), pnt=mem.destplanet, sys=mem.destsys} ), mem.cargo, mem.amount, mem.destplanet, mem.timelimit, piracyrisk )
