...
function create ()
   ...
   misn.setNPC(_("A laid back person"), "neutral/unique/laidback", _("You see a laid back person, who appears to be one of the locals, looking around the bar."))
...
function takeoff()
   ...
   pilot.clear()
   local location1 = vec2.newP(math.sqrt(rnd.rnd()) * system.cur():radius(), rnd.angle())
   local location2 = vec2.newP(math.sqrt(rnd.rnd()) * system.cur():radius(), rnd.angle())
   local location3 = vec2.newP(math.sqrt(rnd.rnd()) * system.cur():radius(), rnd.angle())
