...
if lang == "es" then
    ...
    text[5] = [[    When you arrive at your ship's airlock, the chest containing the Dvaered holopainting is already being carted onto the %s by a pair of crewmen. You are told to come aboard as well to receive your reward.
    You follow the crewmen as they push the cart through the main corridor of the ship. Soon you arrive at a door leading to a large, luxuriously appointed compartment. You can tell at a glance that these are Baron Sauterfeldt's personal quarters. The Baron himself is present. He is a fat man, wearing a tailored suit that manages to make him look stately rather than pompous, a monocle and several rings on each finger. In a word, the Baron has a taste for the extravagant.
    "Ah, my holopainting," he coos as the chest is being carried into his quarters. "At last, I've been waiting forever." The Baron does not seem to be aware of your presence at all. He continues to fuss over the holopainting even as his crewman strip away the chest and lift the frame up to the wall. You glance at the three dimensional depiction of a Dvaered warlord, who seems to be discussing strategy with his staff. Unfortunately you don't seem to be able to appreciate Dvaered art, and you lose interest almost right away.
...
function land()
    if planet.cur() == planet.get(planetname) and not talked then
        thief1 = misn.npcAdd("talkthieves", "Sauterfeldt's agents", "none", npc_desc) -- TODO: portraits
        thief2 = misn.npcAdd("talkthieves", "Sauterfeldt's agents", "none", npc_desc) -- TODO: portraits
        thief3 = misn.npcAdd("talkthieves", "Sauterfeldt's agents", "none", npc_desc) -- TODO: portraits
    end
end
