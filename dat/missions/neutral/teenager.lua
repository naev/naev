...
function targetDeath()
   ...
   vntk.msg(_("Whoops!"), fmt.f(_([[You have destroyed the Gawain! The family presses charges, and you are sentenced to a #r{credits}#0 fine in absentia.]]), {credits=fmt.credits(-fine)}))
