...
function create ()
   ...
   tk.msg(_("Shipwrecked space family"), text[1])
   tk.msg(_("Shipwrecked space family"), string.format(text[2], _("August")))
...
function land()
   if planet.cur() == destplanet then -- We've arrived!
      if nextstop >= 3 then -- This is the last stop
         tk.msg(_("Rid of them at last"), string.format(text[3], destsys:name())) -- Final message
         player.pay(500e3)
