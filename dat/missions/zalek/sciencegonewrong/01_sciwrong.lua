...
-- DESCRIPTION: Dr. Geller asks you to disable a soromid ship to retrieve some technologie
...
-- mission variables
   ...
   bar_desc = "You see Dr Geller and he is waving you over. Apaprently he has another job for you."


   title[1] = [[In the bar]]
   text[1]  = [["Ah there you are! I've got a job for you. I am so close to revolutionizing science! I will become a dinosaur of science! The T-Rex of progress! Well, this job involves some acquisation of technology from the Soromid. They did not want to give it to me and so for science you will have to get it for me. Are you up for it?]]
   text[2] = [["Excellent. From what I have been told it looks like this." He says gesticulating around with his hands to no merit. "You will recognize it, it is in a box that should be kept seperately from the remaining stuff and labelled top secret! Not secret enough now, I suppose! Ah you might need this!" and he hands you a handheld device.
"Oh and the ship is called the %s"
You realize that you are supposed to steal something top secret. Quriky people those Za'leks. With the coordinates, the signature of the target ship and the handheld, which you hope helps you detect the box, you get yourself on the way.]]
-- msgs by soromid forces
   title[2] = [[Intercom]]
   text[3] = [["You have commited and act of aggression against the House Soromid. Stand down or suffer the consequences."]]
   title[3] = [[In the ship]]
   text[4] = [[You make your way through the ship, the crew is obviously shaken and not very prepared for fighting. By weilding your guns you can convince them to not cause any trouble, so you can see how they despise you with their looks. Clearly you have not made any friends here today, but who wants to be friends with those mutants anyway, you justify to yourself. You search through the ship and the handheld in your pocket starts beeping. 
...
Well this was the easy part, you think. Now off to the escape.]]
   ...
   text[5] = [["Have you got it?" asks Dr Geller. "Ah, marvelous! Do you know what this is? This is a quantum sharpener. It's like a quantum erazer, but it does not eraze but sharpen. This is exactly what I needed. I think with this I should be able to finish my Prototype. 
