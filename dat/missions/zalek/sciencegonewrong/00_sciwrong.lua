...
function spwn_police ()
      lance1 = pilot.add("Empire Lancelot", system.get("Provectus Nova"))
      lance1 = lance1[1]
      lance2 = pilot.add("Empire Lancelot", system.get("Provectus Nova"))
      lance2 = lance2[1]
      adm1 = pilot.add("Empire Admonisher", system.get("Provectus Nova"))
      adm1 = adm1[1]
