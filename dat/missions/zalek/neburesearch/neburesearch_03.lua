...
function enter_ship()
    ...
    vn.func( function ()
        if mem.has_lab_coat then
            ...
            faction.hit("Za'lek", nebu_research.fctmod.znr03_lab_coat)
        else
        ...
        if mem.learned_text then
            ...
            faction.hit("Za'lek", nebu_research.fctmod.znr03_learned_speech)
        elseif mem.has_glasses then
            ...
            faction.hit("Za'lek", nebu_research.fctmod.znr03_glasses)
        else
...
You haven't understood the question, not even a single word.]]))
    ...
    vn.func( function ()
        faction.hit("Za'lek", nebu_research.fctmod.znr03_questions)
    end )
    vn.done()
