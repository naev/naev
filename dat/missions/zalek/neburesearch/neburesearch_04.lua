...
function land()
    ...
    You continue your tour, as you come close to one of the windows from the corner of your eye you see something fall outside, followed by a dull thump. Looking out of the window you see a figure dressed in a lab coat trying to stand up slowly. You're about to open the window and ask if he needs help, but he notices you and gestures to be silent as he hobbles off. Those Za'lek are indeed trying to escape the party.]]))
            tk.msg(_("Crashing a party"), _([["At least the ice cream is great!" you think as you take another bite. Suddenly someone grabs your arm. "We're done here. Bring me back to %s!" Dr. Mensing quietly tells you. For a moment you wonder what she is doing as she drags you towards the bathroom; finally you remember what she said about her 'escape strategy'. She mentioned that you are supposed to leave the building through the window of the bathroom.]]):format(dest_planet:name()))
            misn.markerMove(misn_marker, dest_sys)
            misn.osdActive(2)
        elseif stage == 7 then
            tk.msg(_("Finally back home"), _([["That took long enough! I'm glad Professor Voges promised to take care of the funding. The problem was that my recent research is related to a secret project on Ruadan Prime and my funding was shut down - like some kind of conspiracy; can you believe it! Actually I'm not supposed to tell you anything as you could possibly get into a lot of trouble.. forget I said anything! I have much work to do!"
...
function warningMessage()
    tk.msg(_("Caution!"), _([[You receive a system wide broadcast. It appears to be a warning. "Caution! A drone squadron in the %s system went haywire! Proceed with care."
    Why is this happening so frequently in Za'lek space? On a second glance you see on your radar that a drone squadron is flying right towards your ship.]]):format(system.cur():name()))
end

function secondWarningMessage()
    tk.msg(_("Caution!"), _([[The now familiar warning appears once again on your ship's screen. "Caution! A drone squadron in the %s system went haywire! Proceed with care."
    Just how often is this going to happen?]]):format(system.cur():name()))
end
