...
proposal_text = _([["It appears we keep running into each others, %s. You may be happy to hear that I finished my theoretical work on the nebula resistant shielding technique. Of course I can't provide you a shielding system. We scientist usually don't bother with engineering. However, in this case I'd actually like to build a prototype shielding device. The prospect of exploring the Sol system is just too tempting.
    "And this is were you come into play. I need a few capable engineers and some expensive hardware. My budget is too small though. This is why I have to acquire additional funding. Your task will basically be to chauffeur me around. Apparently it is sometimes required to show up in person. So annoying..."]])
...
first_planet_text = _([[After landing on %s Dr. Mensing tells you to wait until she returns. "Not more than a couple of periods," she said. In fact you had to wait for only two periods until she returned. She appears to be downhearted.
    "This is in fact the first time that one of my applications was rejected. That's weird. I got positive feedback at first. It makes no sense that my application was rejected on the last minute. I guess things like this happen. Let's just go to %s in the %s system next and try again."]])
second_planet_text = _([["Alright, I'm sure it will work out this time!", Dr. Mensing said on arriving on %s. This time you have to wait even longer for her to return. The result is the same as for the first try though.
...
ruadan_text = _([[Apparently you are not allowed to land on %s and explaining the situation was futile. Dr. Mensing enters the cockpit asking why you are not landing, "We're not allowed to? Let me try to talk with them."
...
party_professor_text = _([[You wonder if anything of that was meant serious. Before you can ask, Dr. Mensing runs off engaging an older looking man, probably Professor Voges. She does not waste any time and brings up the issue straight on, visibly discomforting him. It's time to explore the party.
    You expect a Za'lek party to be much different from a regular party. In fact the first two things you notice are the classical music and the abundance of any alcoholic drinks. There is however a buffet and in particular a small fridge with ice cream. You can spot a fair amount of people eating ice cream. Is this the Za'lek equivalent of beer?
    Before you realize you're engaged in a conversation with one of the scientists. Apparently he saw you entering together with Dr. Mensing which motivates him to ask the question whether you are her date. In an attempt to correct his statement you tell him that she hired you. He may misunderstood you.
    You continue your tour. When you come close to one of the windows you see from the corner of your eyes something falling down outside, followed by a dull impact noise. Looking out of the window you see a figure dressed in a lab coat trying to stand up slowly. You're about to open the window and ask if he needs help, but once he lifts his head and notices you he gestures to be silent and hobbles off. Those Za'lek are indeed trying to escape the party.]])
party_end_text = _([["At least the ice cream is great!" you think and take another bite. Suddenly someone grabs your arm. "We're done here. Bring me back to %s!" Dr. Mensing said. For a moment you are irritated as she drags you towards the bath room. Finally you remember what she said about her 'escape strategy'. Apparently you're supposed to leave the building through the window of the bath room.]])
home_title = _("Finally back home")
return_text = _([["That took long enough! I'm glad Professor Voges promised to take care of the funding. The problem was that my recent research is related to the secret stuff on Ruadan Prime and my funding was shot down - like some kind of conspiracy. Can you believe it? Actually I'm not supposed to tell you anything as you could possibly get a lot of trouble. Nevermind. I have much work to do!"
...
warning_text = _([[You receive a system wide broadcast. It appears to be a warning. "Caution! A drone squadron in the %s system went haywire! Proceed with care."
    Is that happening frequently in Za'lek space? On a second look you see on your radar that a drone squadron is flying right towards your ship.]])
