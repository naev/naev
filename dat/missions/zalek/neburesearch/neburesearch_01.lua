...
function land()
   ...
   elseif spob.cur() == homeworld then
      ...
      local mensing = vn.newCharacter( nebu_research.vn_mensing() )
      vn.transition("fade")
      vn.na(fmt.f(_("After leaving the ship, you meet up with Dr. Mensing who hands you a chip worth #g{credits}#0, and thanks you for your help."), {credits=fmt.credits(credits)}))
