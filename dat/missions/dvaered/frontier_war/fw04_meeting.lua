...
propose_text = _([[As you sit at his table, the clearly anxious Dvaered pilot stops biting his nails and explains why he is here.
   "The High Command summoned, under request of general Klank, an extraordinary meeting of the high council of Warlords, and all of them have accepted to come..." You frown, and before you have a chance to ask where is the problem, he continues: "... but we recieved an intelligence report according to which the ex-colonel Hamelsen (who has already tried to murder Major Tam several times) has for totake advantage of this meeting to take action against us."
...
lore_text[1] = _([["Both squadrons of the DHC station's space security force will be deployed with full range ships from Vendettas to Goddards. Those squadrons are 'Beta-Storks' and 'Beta-Hammer' and their missions will be to control medium and heavy ships and to provide anti-heavy firepower in case of need. Our squadron, named 'Alpha-NightClaws', is in charge of fast ships (Yachts and Fighters). We will be flying Hyenas.
   "The procedure is the following: any ship approaching the station will be assigned to a squad by the fleet leader, and then to a pilot by the squad leader (Captain Leblanc). When a ship is attributed to you, it will appear green on your screen, and you'll have to hail the pilot and request the security clearance code. The code will be automatically processed by the system we install right now on your core unit. Afterwards, the ship will be allowed to land, or ordered to fly away. The same thing happends for ships that leave the station.
   "Finally, in case something happends, you will of course have to obey to orders. Watch your messages closely. A few pilots will be kept in reserve close to the station.
