...
-- luacheck: globals ambushDied ambush_end ambush_msg attackMe enter explain_battle hamelsen_attacked land loading meeting meeting_msg1 meeting_msg2 meeting_msg3 moreBadGuys tamDied tamJump (Hook functions passed by name)
