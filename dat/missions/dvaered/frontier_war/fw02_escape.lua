...
accept_text1 = _([["Alright," Leblanc says, "Here is the situation: before starting to actually prepare our military operations, we need to protect our backs. And for that, Major Tam believes that the House Goddard is the key to ensure that the Empire will not thwart our plan. Tam would explain it much better than I, but as Goddard is right inbetween our space and imperial space, they really have much to loose in case of a direct conflict. What is more, as we are House Goddard's best customer, they tend to appreciate us (for example, we recently paid 6M credits to repair all the electronics of Klank and Battleaddict's Goddards).
   However, all the members of Goddard's executive board do not share the same view as regards our projects of invasion of the Frontier. Mr. Danftang, their Public Relation Manager, in particular, used to see it as an opportunuity to sell more cruisers to the High Command and was very favourable to the invasion. This man has been arrested recently by the Za'lek police for unclear reasons and many suspect this is linked to a scheming settled by Goddard shareholders. As you have probably already guessed at this point, our mission is to make this man escape the Za'lek prisons."]])
...
therus_text = _([["Hi, citizen. Are you ready to transport us once more? Have you spoken to the Captain? And to the pilot? I don't really know the details of the operation, so you'll have to ask them."
   ...
   Strafer then arrives: "Yep, I've been to the museum of Theras one day, and this riddle was written on a book from before the space age. The name of the author was: 'Senior High School Philosiphy Class' that's a strange name actually. I remembered that riddle while we were hiking on %s not so long ago, and we saw a turtle."]])
...
explain_text = _([[While you finally jump out, Hamfresser reports: "We've got an unexpected situation in there. After we destroyed the androids, and got to the imprisonment room, we saw that there were three other prisonners along with the target, and much more human gards than expected. They exploded our first assault bot, and we had to take them down with the paralizers, but one of the prisonners took a weapon for some reason and started to shoot on us. Fortunately for me, he just botched my lung. That is a replaceable part.
...
die_text = _([[After having outrun your enemies, you start inquiring about how the operation went at the hospital. A quick look at your living quarters gives you an answer. You see the VIP, still unconscious, but not blue anymore, his body covered by electrodes connected to the machine in question. Next to him, the members of the commando look like they had better days. Hamfresser, his face as pale as death, sits on the ground, leaned on a pillar, buisy at changing a long and blood-dripping bandage on his left arm. The sergeant Nikolov looks at a huge hole in her foot with an empty eye and the medic Therus limps from the one to the other, spreading blood marks on the walls.
   In the center of the room is lying private Tronk, covered with bandages. His battlearmor, pierced with multiple holes, has been thrown a few meters away in a blood puddle. The soldier looks at the two remaining fingers of his less damanged arm that are slowly walking on the ground, in a sad smile. "Leoplod, you remember when you were a kid? Did you play with your fingers like that?" Hamfresser answers: "Tronky-boy, don't use my first name, only dying people have used my first name before..." "Don't be afraid, this won't change, Leopold."
...
imperial_text1 = _([[The pilot of the ship starts to talk with a strange and disturbing familiraity: "Doing good, folks? Ya just walked into those Za'lek's freak's space, wrecked a squadron, helped a prisonner escape and desolated an hospital. You're worse than the incident, mates!" You wonder how this pilot could know so much about your operation, but the spiel continues: "Hewhewhew! People usually think I'm one of those useless pirates scum. I know you thought about that! Neh, don't lie to me!"
   The pilot's voice suddently becomes harsh: "In reality, I am a faithful subject of his Imperial Majesty, as you should be youself, %s from Hakoi! But you denied your own nation, and for that you should be severely punished. Don't forget, %s: The Empire is watching you. Anywhere. Anytime. Anyhow.
...
pir_yes_text = _([[When you give the credit chip, the pirate looks surprised: "Whow, mate, I didn't know I was talking to a milionnaire. Well then thanks, here is your transponder."]])
pir_notenough_title = _("Not enough money")
pir_notenough_text = _([["Don't try to trick me, crook! I can see frome here that you don't have enough money!"]])
