...
function land()
   ...
   The major starts to go away, but then comes back "Oh, I almost forgot to pay you. Hehe. Here are #g{credits}#0."]]), {credits=fmt.credits(fw.credits_02)}))
   ...
   The major starts to go away, but then comes back "Oh, I almost forgot to pay you. Hehe. Here are #g{credits}#0."]]), {price=fmt.credits(fw.pirate_price), credits=fmt.credits(fw.credits_02)}))
