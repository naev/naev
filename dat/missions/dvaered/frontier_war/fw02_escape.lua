...
function accept()
   ...
   tk.msg(_("The problem to solve"), fmt.f(_([["The target is currently imprisoned on {pripla} in {prisys}, in Za'lek's VIP carceral center on this planet. He will be transferred to {zlkpla} in {zlksys} for a preliminary interview with the judge. The Za'lek don't expect anybody to try to free him by violence, so they don't take too many precautions.
