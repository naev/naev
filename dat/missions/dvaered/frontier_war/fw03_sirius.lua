...
function accept()
   ...
   "Our side will not have much firepower, so I'm counting on you to provide arrive with a lot of armour and guns (but you should still be able to outrun mid-range destroyers). Because you two worked so well in the past, you'll again team up with Lieutenant Strafer, and two other pilots. But the SOF does not have an endless supply of pilots, so your reward will depend on how many of them come back. Strafer will fly a scout with high performance sensors. He will be our eyes, so his death would mean the end of the mission.
