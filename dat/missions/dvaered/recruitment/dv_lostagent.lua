...
function accept()
   ...
   vn.na(_([[A mysterious soldier, a confidential identity and a secret delivery. You look at the small Dvaered insign on your interlocutor's chest: are your ready to work with that Great House?
...
Oh, I almost forgot! There is one thing you are authorized to know: this cargo is transferred to the Empire as a part of the Dvaered-Empire collaboration program.]]), {pnt=mem.spob1:name(), sys=sys}))
   ...
   misn.setDesc( fmt.f(_("You have to transfer a parcel destinated to the Empire on {pnt} in {sys}"), {pnt=mem.spob1,sys=sys}))
...
3) You will be rewarded for that]]))
   ...
   elseif mem.misn_state == 1 and spob.cur() == mem.spob2 then
      ...
      vn.transition( )
      vn.na(_([[A group is waiting at your dock. Before you proceed with the final landing proceedure, Boudica looks at them with binoculars, and then confirms they are the Imperial team.
You dock at the spaceport and step out on the platform. Workers immediately take your cargo in charge, under the protection of armed cyborgs.]]))
      vn.na(_([[You observe the soldiers, looking for imperial insigns or gallons, in vain. You accidently make eye contact with one of the cyborgs, which cause the blood in your veins to instantly freeze. Does this guy have scars INSIDE the eyes? How is it only possible?
A seemingly-unarmed man steps forward. He must be the imperial agent in charge of the operation.]]))
      ...
      agent2(fmt.f(_([[Come on... Anyways, I think it's time to get that swan. If the FLF is implied in the disappearance, so is the swan. The good thing is that we know that he is supposed to have buisness in {sys} soon.]]),{sys=mem.flfsys}))
      ...
      agent2(_([[Yeah, I've made a backup request to the Imperial Lair's Secretary, but the Second Archbishop of Mayhem has opposed a veto, so I only have access to the squadrons that are outside of his juridiction. And I finally got squadron 138...]]))
...
Meanwhile, our boy Ak-Ak did make his investigation. He got his cyborgs to break a few knees and now we know what happened to the lost pilot.]]),{name=player.name()}))
      ...
      agent(_([[And now, the Imperials want to avenge their pilot. They found track to the pirate pilot, who is called 'The Death Dealer'. He is a clanless pirate, wanted by the Imperial police, as well as a few other faction's authorities. But he never borke the law in Dvaered space, where he is a peaceful trader under his real name: Chilperic Duchmol.]]))
...
function discussWithAg()
   ...
   vn.label("details")
   agent(fmt.f(_([[Acording to our information, Shaky Swan is in the Frontier sector right now, flying a Lancelot, presumably under FLF transponder. He might soon enter {sys1} from the jump point to {sys2}.
