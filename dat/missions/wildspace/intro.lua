...
function land ()
   if mem.state==0 and spob.cur() == target then
      ...
      vn.na(_([[Staying low you make your way across the rubble. No sign of life for now other than some fungus that grows on the cracks and crevices throughout the decrepit structures. You notice some sort of tattered flag nearby; it seems like that is your destination.]]))
...
"{player}, there seems to be many lifeforms converging on your location. My preliminary analysis indicates that they want to skin you alive."]]),
      ...
      vn.scene()
      vn.transition()
      vn.na(_([[You grab the satchel and run onto the ship, just in time it seems. You can make out more figures as the landing gear closes and you take off. Time to get out of here.]]))
   ...
   elseif mem.state>=1 and spob.cur() == main then
      ...
      vn.na(_([[After your ordeal, you once again make your way through the airlock. It is oddly silent. You arrive the cantina, but hear no welcome. You try to make some noise to catch the attention of the inhabitant but to no avail. Not really knowing what you do, you decide to delve deeper into the structure.]]))
