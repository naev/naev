...
function jumpin ()
   ...
   if rnd.rnd() > chance or system.cur():presence("Wild Ones") < 10 then
      return
   end
...
function owner_board ()
   ...
   vn.na(fmt.f(_("You sit resigned and outwitted at your command chair when you notice a credit chip with {credits} on the floor. It looks like it has cat bite marks too."),{credits="#g"..fmt.credits(credit_reward).."#0"}))
   vn.sfxVictory()
   ...
   faction.get("Wild Ones"):hit( 30, nil, nil, true )
