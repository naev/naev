...
function owner_hail ()
   ...
   vn.na(fmt.f(_("You open a communication channel with the {plt} and a hologram of a nervous-looking individual materialises in front of you."),{plt=owner}))
...
function owner_board ()
   ...
   vn.na(_("You realise the cat is no where to be seen, and start to search for it to bring it over. Funny how it always seems to be where you don't want it and when you need it you can't find it."))
   vn.sfx( meow )
