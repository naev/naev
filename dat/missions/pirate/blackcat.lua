...
function owner_board ()
   ...
   vn.na(fmt.f(_("You sit resigned and outwitted at your command chair when you notice a credit chip with #g{credits}#0 on the floor. It looks like it has cat bite marks too."),{credits=fmt.credits(credit_reward)}))
   vn.sfxVictory()
