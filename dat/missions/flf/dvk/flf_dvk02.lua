...
function pilot_hail_boss ()
   ...
   if mem.stage <= 1 then
      if mem.boss_impressed then
         ...
         tk.msg( _("Not So Weak After All"), _([[The pirate comes on your view screen once again, but his expression has changed this time. He's hiding it, but you can tell that he's afraid of what you might do to him. You come to the realisation that he is finally willing to talk and suppress a sigh of relief.
