...
function accept ()
   tk.msg( _("The enemy of my enemy..."), _([[Benito motions for you to sit. She doesn't seem quite as calm and relaxed as she usually is.
    ...
    "But that being said, I think I may have found a solution. See, we have reason to believe that we are actually neighboring a pirate stronghold. We're not entirely sure, but we have detected some evidence of occasional pirate activity in the nearby %s system."]]):format( player.name(), missys:name() ) )
   if tk.yesno( _("The enemy of my enemy..."), _([[You raise an eyebrow. It seems rather odd that pirates would be in such a remote system. Perhaps it could be a gateway of some sort?
    ...
    "We must establish trading relations with that stronghold at once. This could give us just the edge we need against the Dvaereds. I honestly don't know how you can go about doing it, but my recommendation would be to go to the %s system and see if you find any pirates. Tell them you're on official FLF business, and that we're seeking to become trade partners with them. Are you in?"]]):format( missys:name() ) ) then
      tk.msg( _("...is my friend."), _([["Excellent! I knew you would do it." Benito becomes visibly more relaxed, almost her usual self. "Now, %s, I'm sure you're well aware of this, but please remember that pirates are extremely dangerous. They will probably attack you, and they may have demands. I'm counting on you to overcome any... obstacles you may encounter and secure a deal." You nod in understanding. "Good," she says. "Report back here with your results." Benito then excuses herself, presumably to take care of other things.]]):format( player.name() ) )
