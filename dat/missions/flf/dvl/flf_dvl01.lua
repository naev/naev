...
function create()
   ...
   local npcgregar = vn.newCharacter ( _("Gregar"), {image="gregarimage.webp"})
   vn.transition()
   vn.na(_([[A haggard-looking man emerges from the airlock.]]))
   nv.npcgregar(_([[Thank goodness you're here. My name is Gregar, I'm with the Frontier Liberation Front. I mean you no harm. 
   I have come under attack from a Dvaered patrol. I wasn't violating any laws, and we're not even in Dvaered territory! Anyway, my ship is unable to fly.]]))
   vn.na(_([[You help Gregar to your cockpit and install him in a vacant seat. He is obviously very tired, but he forces himself to speak.]]))
   vn.npcgregar(_(fmt.f( _([[Listen, I was on my way back from a mission when those Dvaered bastards jumped me. I know this is a lot to ask, but I have little choice seeing how my ship is a lost cause. Can you take me the rest of the way? It's not far. We have a secret base in the {sys} system. Fly there and contact my comrades. They will take you the rest of the way.]], {sys=mem.destsys}))))
   vn.na(_([[Gregar nods off, leaving you to decide what to do next. Gregar wants you to find his friends, but harbouring a known terrorist, let alone helping him, might not be looked kindly upon by the authorities...]]))
   vn.run()
...
function enter()
   ...
   elseif mem.gregar1 and mem.gregar2 and not mem.gregar3 then
      ...
      vn.scene()
      vn.transition()
      vn.na(_([[As you exit hyperspace, you notice Gregar exploring your star maps. Knowing he's probably been to all the places you know of and more, you ask him how he ended up getting involved with the FLF.]]))
      vn.npcgregar(_([["The easy answer would be that I grew up on the Frontier so protecting it is just something I have to do. But it isn't that simple. I always strive to do the right thing, I think most people are like that. But oftentimes, I find it hard to tell what the right thing to do is. When I first heard about the FLF and what they were fighting, it seemed like this was an easy way to just know the right thing and do it. But as I've been out in Dvaered space now, I'm not so sure anymore."
      "Are we the good guys doing the right thing? Are they the bad guys? If so, what makes them bad, and what makes us good? I kind of miss being a kid when things were easy to tell. All those vid-series always made it obvious who the good guys were and who the bad guys were. Real life isn't nearly as helpful."]]))
      vn.na(_([[You contemplate about Gregar's questions for a while. In your experience so far, if the other ship is shooting at you, that makes it a bad guy. Pretty simple. But maybe it isn't. Maybe the pirates are shooting first to make sure you don't get the jump on them. Maybe underneath all that bluster is a scared pilot trying to make it to the next day. You are about to curse your luck as the familiar snoring starts to grow when suddenly it goes silent...]]))
      local sai = vn.newCharacter( tut.vn_shipai() )
      vn.transition()
      vn.sai(_([[I took the liberty of tuning some audio panels during our last hyperspace jump to directly cancel Mr. Gregar's snoring. I was worried not doing so would not only compromise our hull integrity, but also the integrity of my sanity.]]))
      vn.na(_(fmt.f( _([[You are so enamored by the sound of silence that you start to tear up a little. You look at {shipai} and exclaim that if they were real you would kiss them right now!]]), {shipai=tut.ainame()})))
      vn.sai(_([[While I appreciate the sentiment, I'm currently seeing an accounting AI in Empire Space]]))
      vn.na(_([[You briefly start pondering the logistics of AI romance, but quickly dismiss it as a rabbit hole that should not be explored at this time. For now, you sit back and enjoy the solace, and silence, of space once more.]]))
      mem.gregar3 = true
      vn.run()
   elseif mem.gregar1 and not mem.gregar2 then
      ...
      vn.scene()
      vn.transition()
      vn.na(_([[Gregar comes back onto the bridge after you enter the system. He seems to be getting better as you make your way through space. Hopefully you can avoid his snoring for a while. You wonder if snoring like that is possibly the cause of his ship no longer functioning.]]))
      vn.npcgregar(_(fmt.f( _([[Ah, {player}! Good to see you again. I was hoping we could speak a little more about the Dvaered.]]), {player=player.name()})))
      vn.na(_([[You agree, but mention that you do not know very much about them yourself.]]))
      vn.npcgregar(_([[I didn't expect you would. You're still a little green behind those controls it looks to me. Almost everyone knows that being Dvaered means you either are part of the military or you don't go anywhere in life. Well, that's a bit of an oversimplification. It's true that the Dvaered only recognize military prowess for governing ability, but those that don't join the military aren't living in squalor.]]))
      vn.na(_([[You hadn't really given much thought to what happens to those that don't join the military in Dvaered space.]]))
      vn.npcgregar(_([[As part of my 'duties', I lived on a few Dvaered worlds for a time. Because their Great House was established due to the revolts, those who don't join up with the local military for whatever reason can live very fulfilling lives. There are plenty of non military jobs that need doing after all. While those who pursue them won't ever become a Warlord, they also are able to live quite comfortably. Some even say they enjoy better standards than Za'lek scientists.]]))
      vn.na(_([[You sit contemplating this while gliding through the empty starscape. The Dvaered military seems downright brutish in most dealings people have with them. It seems strange that with all the bluster and emphasis on military achievement, there is an entire non-warlike Dvaered society out there.]]))
      vn.na(_([[Your thoughts are interrupted by an all too familiar sound. Gregar's snoring is likely to start shaking the rivets out of your bulkheads if you don't get him home soon.]]))
      mem.gregar2 = true
      vn.run()
   elseif not gregar1 then
      ...
      vn.scene()
      vn.transition()
      vn.na(_([[Gregar gets jarred awake after your departure from hyperspace. He's groggy, but starts talking to you about his current predicament.]]))
      vn.npcgregar(_([[Thanks again for grabbing me from my ship. It seems you are pretty unfamiliar with the lay of the land right now where it comes to the Dvaered and the Frontier. Am I correct?]]))
      vn.na(_([[You nod your agreement. You have barely heard of the Frontier, and most of your interactions with the Dvaered have been watching them put as much firepower into space as possible.]]))
      vn.npcgregar(_([[I thought so. Well, us at the Frontier Liberation Front are at odds with the Dvaered because they want to come in and share their brand of 'peace' with us. I'm sure you've seen what that looks like, and quite frankly, it isn't something many of us are interested in. So we set out to try to stop it before they get their way. Fortunately, because they are governed by warlords in each individual star system, we have been able to thwart their advances due to general lack of coordination on their part. Unfortunately, they never seem to tire of conflict, and many regular people do, so we need to find a way to win for good, soon, or they are likely to win just through attrition.]]))
      vn.na(_([[Gregar sighs heavily, and slumps back into his chair. It only takes a few seconds before he starts to snore loudly again. Maybe he can give you a bit more information after he gets some more rest.]]))
      mem.gregar1 = true
      vn.run()
   end
end
...
function wakeUpGregarYouLazyBugger()
   ...
   vn.scene()
   vn.transition()
   vn.npcgregar(_([[Wha- hey! What's going on!]]))
   vn.na(_([[You were too busy dodging incoming fire, rebalancing your shields, and generally trying to kill your attackers before they kill you to notice that Gregar, your passenger, has roused from his slumber. Clearly the noise and the rocking have jolted him awake. You snap at him not to distract you from this fight, but he desperately interrupts.]]))
   vn.npcgregar(_([[These guys are my contacts, my friends! I was supposed to meet them here! Oh crap, this is not good. I didn't realize I'd be out this long! Look, I need to use your comm array right now. Trust me!]]))
   vn.na(_([[Before you have a chance to ask him what he thinks he's doing, Gregar begins tuning your communications array, and soon finds the frequency he wants.]]))
   vn.npcgregar(_(fmt.f( _([[FLF sentinel formation, this is Lt. Gregar, authorization code six-six-niner-four-seven-Gamma-Foxtrot! Cease fire, I repeat, cease fire!
      Same to you, {player}. Stop shooting. This is a misunderstanding, they're not your enemies.]]), {player=player.name()})))
   local npcFLF = vn.newCharacter(_("FLF Sentry"), {image="tristan.webp"})
   vn.na(_([[You are skeptical at first, but a few seconds later it becomes apparent that the FLF fighters have indeed ceased firing. Then, there is an incoming comm from the lead ship.]]))
   vn.transition()
   vn.npcFLF(_([[This is FLF sentinel Alpha. Lt. Gregar, authorization code verified. Why are you with that civilian? Where is your ship? And why didn't you contact us right away?]]))
   vn.npcgregar(_([[Apologies, Alpha. It's a long story. For now, let me just tell you that you can trust the pilot of this ship. This pilot kindly helped me out of a desperate situation, and without that help I probably would never have returned alive. Request you escort us to Sindbad.]]))
   vn.npcFLF(_([[Copy that Lt. Gregar.
      Please follow us. We will guide you to our base. Stay close. Sensor range is lousy in these parts, and if you get separated from us, we won't be able to find you again, and you won't be able to find us or our base.]]))
   vn.na(_([[With that, Alpha breaks the connection. It seems you have little choice but to do as he says if you ever want to take Gregar to his destination.]]))
...
function inRange()
   mindist = 2e3
   local ppp = player.pos()
   for i, p in ipairs(fleetFLF) do
      if p ~= nil and p:exists() then
         mindist = math.min(mindist, vec2.dist(p:pos(), ppp))
      end
   end
   if mindist < 500 then
      hook.timer(2, "annai")
      mem.OORT = hook.timer(10, "outOfRange")
   else
      hook.timer(0.5, "inRange")
   end
end

-- Function to make FLF fleet immortal
function immortalFLF()
   for i, p in ipairs(fleetFLF) do
      if p ~= nil and p:exists() then
