...
function mainguy_board ()
   ...
   vn.na(fmt.f(_("You are not able to find what you were looking for, but you were able to find #g{credits}#0 that likely won't be necessary to the crew anymore."), {credits=fmt.credits(reward)}))
