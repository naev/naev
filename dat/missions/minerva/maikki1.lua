...
function enter ()
   if system.cur() == system.get(cutscenesys) and misn_state==1 then
      ...
      pscavB = pilot.addRaw( "Vendetta", "Scavenger", pos, _("Scavenger Vendetta"), "independent" )
      pscavB:control()
      pscavB:brake()
   ...
   elseif system.cur() == system.get(stealthsys) and misn_state==4 then
      ...
      local fscav = faction.dynAdd( "Independent", "Scavenger", _("Scavenger") )
      pscavA = pilot.addRaw( "Shark", "Scavenger", posA, nil, "independent" )
      pscavB = pilot.addRaw( "Vendetta", "Scavenger", posB, nil, "independent" )
   ...
   if stealthtarget==0 then
      ...
      if dist < 500 then
         ...
         if stealthtarget==4 then
            ...
            wreck = pilot.addRaw( "Rhino", "Derelict", pos, _("Ship Wreck") )
            wreck:disable()
            wreck:setInvincible()
