...
function create()
   ...
   misn.setNPC(npc_name, "sirius/unique/draga.png", bar_desc)
...
function takeoff()
   ...
   recon = pilot.addFleet("Sirius Recon Force", system.get("Herakin"))
   attackers = pilot.addFleet("Nasin Sml Attack Fleet", homeasset) --a little assistance
