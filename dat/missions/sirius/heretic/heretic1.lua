...
bmsg[4] = [[Shaman takes a deep breath. "The Nasin were at one point all apart of House Sirius, and believed solely in the teachings of Sirichana. We loved him, and our hearts were his. As all religions do at some point, however, the teachings of Sirichana became weighed down by the ideologies and agendas of man. Most people still accepted these teachings as straight from the mouth of Sirichana himself, but we, the Nasin, knew better."]]
bmsg[5] = [["We started a splinter religion, still trying to cooperate with the Sirians, but when the serra felt threatened (as they well should have, I might add), they branded us as heretics and forced us out of Sirius space. At first, we didn't know what to do, but then, Jan Jusi pi Lawa came to lead us. He was the one who named us, the Nasin, which means "The Way" in an old earth language."]]
bmsg[6] = [[At this point, Shaman seems very excited, caught up in the moment. "It was he! He who led us to join our hands! He who led us to work together! He who led us to fight back against the oppressors! It was he! The very, the only, the True Voice of Sirichana!" 
				Shaman seems to realize just exactly where he was and what he was doing. All the patrons in the bar have their heads turn, and are staring. A group of young fellows started clapping and then degraded into laughing.]]
bmsg[7] = [[Shaman coughed out an "excuse me", and looked at you, embarresed. "It is wrong for me to get so caught up in such things. I suppose you'll want to know about the mission now."]]

--all the messages after the player lands on the target asset
emsg = {}
emsg[1] = [[You receive your clearance to land on %s, and begin your computer-assisted entry into the specified bay. Your not sure exactly what to expect, but you think that they've been expecting you. You successfully dock, and proceed into the hanger, ready for someone to come greet you. No one does. The hanger is oddly... empty. And that is when you notice it.]]
emsg[2] = [[There is an envelope, folded neatly, and laying squarely in the middle of the hanger. You go up to inspect it, and on the front, it simply says "%s". You snatch it up, and open it quickly.]]
emsg[3] = [["Hello %s,
