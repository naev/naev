...
function takeoff() --for when the player takes off from the wringer.
   ...
   sirius_be_serious = pilot.add("Sirius Assault Force", system.get("Herakin"))
   ...
   de_fence = pilot.add("Nasin Med Defense Fleet", homeasset)
   de_fence_2 = pilot.add("Nasin Med Defense Fleet", vec2.new(rnd.rnd(25,75),rnd.rnd(100,350)))
...
function second_coming()
   sirius_be_serious_2 = pilot.add("Sirius Assault Force", system.get("Herakin"))
