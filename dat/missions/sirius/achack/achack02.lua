...
function accept()
   if var.peek("achack02repeat") then
    ...
    You sympathise with Joanne, but you wonder aloud why she hasn't asked the local authorities for protection. Joanne gives you a somewhat uncomfortable look.
