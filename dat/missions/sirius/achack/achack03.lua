...
function accept()
   if var.peek("achack03repeat") then
      tk.msg(_("Talking to Joanne"), _([["Hi %s," Joanne says. "Good to see you again. Say, I still haven't resolved that issue with Harja and the attempts on my life. Any chance you've changed your mind about helping out a damsel in distress? Let me tell you again what I want you to do."]]):format(player.name()))
   else
      tk.msg(_("Talking to Joanne"), _([["Hello there %s," Joanne greets you. "We do seem to keep running into each other, don't we? Like they say, it's a small galaxy after all."
...
function land()
   ...
   if planet.cur() == destplanet and harjatalked then
      ...
      tk.msg(_("Full circle"), _([[You meet Joanne in the spaceport bar. She listens to your account of your conversation with Harja. When you're finished, she frowns.
