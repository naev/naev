...
function hail()
   ...
   if not mem.hailed then
      tk.msg(_("Harja's ire"), _([[You hail Harja's ship. A few moments later his face appears on your console. When he recognises you, his face sets in an angry scowl.
