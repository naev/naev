...
local firstpos = firstsys:waypoints("taiomi05_firstpos")
local fightpos = fightsys:waypoints("taiomi05_fightpos")
local corpsepos = lastsys:waypoints("taiomi05_corpse")
