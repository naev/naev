...
function land_smuggler ()
   ...
   s(_([[Barely able to make what is going on due to the pain, you can make out them whistling to themselves as they approach you. Still stunned and unable to react, they pat you down and take a holodrive you have containing Scavenger's deal.]]))
   ...
   scav(_([["I believe we could reach a mutual agreement to take the contraband off your hands. Have a look at the attached sample. There is more where this comes from."]]))
...
"Every human has their weakness, and the smuggler was no exception. Some want credits, some want fame, but others want more… special things."]]))
   s(_([["They had a weakness for historical documents, many of which we have recovered throughout our existence. We do not have much need for them any more. It is a small price to pay for our freedom."]]))
   vn.jump("cont01")
