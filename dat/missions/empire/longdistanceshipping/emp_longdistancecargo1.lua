...
function accept ()
   ...
   if (var.peek("es_misn") or 0) < 2 then
      czesc(fmt.f(_([[You approach Lieutenant Czesc, who seems a bit busy. "Hey, {player}. I've got some potential work for you. However, the Empire requires a minimum of experience with shipping missions before I can entrust you with it. Try to do a few Empire Shipping missions and get back to me."]]),
         {player=player.name()}))
