...
function accept ()
   ...
   tk.msg( _("Dvaered Long Distance Recruitment"), text[2] )
   ---Accept the mission
   misn.accept()
   ...
   misn.setDesc( string.format( _("Deliver a shipping diplomat for the Empire to Praxis in the Ogat system"), targetworld:name(), targetworld_sys:name() ) )
