...
if lang == "es" then
   ...
   text[3] = [["If all goes well, the commandos will return here with the results after 10 hours. Then we'll have a definitive answer on the communications issues. We aren't anticipating problems on the return, but we'll have some ships ready just in case they're pursued."
   ...
   text[4] = [[Your ship touches ground and you once again see the face of Lt. Commander Dimitri.
    "How was the trip? I trust you didn't have too many issues evading the Collective. We won't hear from the commandos until 10 hours from now when they get back, but I believe everything went well."
