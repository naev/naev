...
"We haven't heard from the commando team, so we have to assume the worst. Also, it appears that Collective presence has increased around %s. We need you to go check for survivors. Would you be willing to embark on another dangerous mission?"]]
