...
local cInert      = colour.new_named("Inert")
local cGreen      = colour.new_named("Green")
local cAquaBlue   = colour.new_named("AquaBlue")
local cRed        = colour.new_named("Red")
local cFontGreen  = colour.new_named("FontGreen")
local cYellow     = colour.new_named("Yellow")
local cFriend     = colour.new_named("Friend")
local cHostile    = colour.new_named("Hostile")
local cNeutral    = colour.new_named("Neutral")
local cRestricted = colour.new_named("Restricted")
local cGrey80     = colour.new_named("Grey80")
