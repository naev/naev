...
skills.set.bite = {
   ...
   ["bite2"] = {
      ...
      desc = function( p )
         ...
         return fmt.f(_("The ship will lunge at the target enemy and take a huge bite out of it. +{accel_mod}% accel, +{speed_mod}% speed and -{absorb}% damage taken for {duration} seconds or until target ship is bitten. This ship will do {dmg} damage with its current mass ({mass}). Has a {cooldown} second cooldown period."),{
            dmg = fmt.number(dmg),
   ...
   ["bite3"] = {
      ...
      tier = 3,
      requires = { "bite2" },
      desc = fmt.f(_("Cannibalizing boarded ships will now restore 2 points of armour per 3 points of armour cannibalized, and boarding will cause your ship to perform a full cooldown cycle. In addition to that, lunge now provides -{absorb}% damage taken and {heal}% of bitten armour is restored to the ship."),{
            absorb=-60,
            heal=10,
      }),
   ...
   ["bite4"] = {
      ...
      tier = 4,
      requires = { "bite3" },
      desc = fmt.f(_("Lunge now provides -{absorb}% damage taken and lunge time increased to {lunge_time} seconds. On successful bite, weapon damage is increased by {weapon_damage}% for {bloodlust_duration} seconds."),{
         lunge_time=5,
         absorb=-80,
         weapon_damage=25,
...
skills.set.carrier = {
   ["carrier1"] = {
      ...
      tier = 1,
      desc = _("Improves fighter damage and durability by 10%."),
   ...
   ["carrier2"] = {
      ...
      tier = 2,
      requires = { "carrier1" },
      desc = _("Improves fighter movement by 20% and fighter bay reload speed by 30%."),
   ...
   ["carrier4"] = {
      ...
      tier = 4,
      requires = { "carrier3" },
      desc = _("Improves fighter damage and durability by a further 15% (25% in total)."),
...
skills.set.plasma = {
   ...
   ["plasma5"] = {
      ...
      tier = 5,
      requires = { "plasma4" },
      desc = fmt.f(_("Creates an explosion of plasma affecting all ships around the pilot. Deals {dmg} damage with {pen} penetration to all hostiles ships within {range} {unit}. Deals an additional {dmg} damage over {duration} seconds while lowering speed, accel, and turn by {move_malus}% and fire rate by {firerate_malus}%. Has a {cooldown} second cooldown."), {
         dmg = 100,
         pen = 100,
         range = 300,
