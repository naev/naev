...
local empire_cores = {
   ["Empire Shark"] = function () return {
         ...
         engines = choose_one{ "Tricon Zephyr Engine", "Nexus Dart 160 Engine" },
         hull = choose_one{ "Nexus Shadow Weave", "S&K Skirmish Plating" },
      } end,
   ["Empire Lancelot"] = function () return {
         systems = choose_one{ "Milspec Orion 2301 Core System", "Milspec Thalos 2202 Core System" },
         systems_secondary = choose_one{ "Milspec Orion 2301 Core System", "Milspec Thalos 2202 Core System" },
   ...
   ["Empire Hawking"] = function () return {
         systems = choose_one{ "Milspec Orion 8601 Core System", "Milspec Thalos 8502 Core System" },
         engines = choose_one{ "Tricon Typhoon Engine", "Nexus Bolt 3000 Engine", "Melendez Mammoth Engine"},
         hull = "S&K War Plating",
      } end,
   ["Empire Peacemaker"] = function () return {
         systems = choose_one{ "Milspec Orion 8601 Core System", "Milspec Thalos 8502 Core System" },
         systems_secondary = choose_one{ "Milspec Orion 8601 Core System", "Milspec Thalos 8502 Core System" },
