...
function taunt ( target, offense )
   ...
   if offense then
      taunts = {
            ...
            "Yep, you're screwed.",
            "Don't know how else to tell you, I just dont like you very much.",
            "How else am I going to pay off my tab?",
            "I think you're being shot at. Yep, pretty sure you are.",
      ...
      taunts = {
            ...
            "I'm sorry, I just dont like you anymore.",
            "I'm sorry, I just dont like you.",
            ...
            "It feels like someone really really hates me all the sudden. Oh, it's just you.",
