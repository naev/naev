...
function create()
   ...
   local function tex_open( name, sx, sy, basepath )
      ...
      local t = tex.new( basepath .. name, nil, nil, sx, sy )
      t:setWrap( "clamp" )
      return t
   end
   player_pane = tex_open( "main" )
   bar_sheen = tex_open( "sheen" )
   bar_bg = tex_open( "bar_bg" )
   bars.armour.icon = tex_open( "armour" )
   bars.energy.icon = tex_open( "energy" )
   bars.fuel.icon = tex_open( "fuel" )
   bars.heat.icon = tex_open( "heat" )
   bars.shield.icon = tex_open( "shield" )
   bars.speed.icon = tex_open( "speed" )
   slotA = tex_open( "slot1-3" )
   slotAend = tex_open( "slot1-3end" )
   slotB = tex_open( "slot4" )
   slotBend = tex_open( "slot4end" )
   slotC = tex_open( "slot" )
   slotCend = tex_open( "slotend" )
   slotAe = tex_open( "slot1e" )
   slotBe = tex_open( "slot2-3e" )
   slotCe = tex_open( "slot4e" )
   cooldown = tex_open( "cooldown", 6, 6 )
   lockonA = tex_open( "padlockA" )
   lockonB = tex_open( "padlockB" )
   ...
   -- Cooldown pane.
   cooldown_sheen = tex_open( "gfx/gui/slim/cooldown-sheen", nil, nil, "" )
   cooldown_bg = tex_open( "gfx/gui/slim/cooldown-bg", nil, nil, "" )
   cooldown_frame = tex_open( "gfx/gui/slim/cooldown-frame", nil, nil, "" )
   cooldown_panel = tex_open( "gfx/gui/slim/cooldown-panel", nil, nil, "" )
