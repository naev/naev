...
function create()
   ...
   popup_bottom2 = tex.open( base .. "tooltipRightBottom.webp" )
   popup_body = tex.open( base .. "tooltipRight.webp" )
   popup_top = tex.open( base .. "tooltipRightTop.webp" )
   popup_empty = tex.open( base .. "tooltipEmpty.webp" )
   popup_pilot = tex.open( base .. "pilotFrame.png" )
   bar_bg = tex.open( base .. "barBg.webp" )
   bar_frame_light = tex.open( base .. "barFrameLight.png" )
   bar_frame = tex.open( base .. "barFrame.png" )
   bar_light = tex.open( base .. "light.png" )
   bar_light = tex.open( base .. "light.png" )
   bar_lock = tex.open( base .. "lock.webp" )
   ...
   fleet_pane_t = tex.open( base .. "frame_fleet_top.webp" )
   ...
   icon_energy = tex.open( base .. "iconEnergy.webp" )
   ...
   icon_cargo = tex.open( base .. "iconCargo.webp" )
   ...
   field_bg_center1 = tex.open( base .. "fieldBgCenter1.webp" )
   field_bg_center2 = tex.open( base .. "fieldBgCenter2.webp" )
   ...
   speed_light_off = tex.open( base .. "speedOff.webp" )
