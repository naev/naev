...
function create()
   ...
   cols.speed2  = colour.new( 114/255,  52/255,  28/255 )
   ...
   --player_pane_t = tex_open( "frame_player_top" )
   player_pane_t = tex_open( "frame_player_top_small" )
   player_pane_m = tex_open( "frame_player_middle" )
   player_pane_b = tex_open( "frame_player_bottom" )
   target_pane = tex_open( "frame_target" )
   ...
   radar_gfx = tex_open( "radar" )
   target_bg = tex_open( "target_image" )
   planet_bg = tex_open( "planet_image" )
   icons.shield = tex_open( "shield" )
   icons.armour = tex_open( "armour" )
   icons.energy = tex_open( "energy" )
   icons.speed = tex_open( "speed" )
   icons.temperature = tex_open( "heat" )
   icons.flow = tex_open( "energy" ) -- TODO
   icons.shield_sm = tex_open( "shield_sm" )
   icons.armour_sm = tex_open( "armour_sm" )
   icons.energy_sm = tex_open( "energy_sm" )
   icons.speed_sm = tex_open( "speed_sm" )
   bgs.bar = tex_open( "bg_bar" )
   bgs.bar_sm = tex_open( "bg_bar_sm" )
   bgs.bar_weapon = tex_open( "bg_bar_weapon_blank" )
   --bgs.bar_weapon = tex_open( "bg_bar_weapon" )
   --bgs.bar_weapon_prim = tex_open( "bg_bar_weapon_prim" )
   --bgs.bar_weapon_sec = tex_open( "bg_bar_weapon_sec" )
   bgs.shield = tex_open( "bg_shield" )
   bgs.armour = tex_open( "bg_armour" )
   bgs.energy = tex_open( "bg_energy" )
   bgs.speed = tex_open( "bg_speed" )
   bgs.temperature = bgs.speed
   bgs.flow = bgs.speed -- TODO
   bgs.ammo = tex_open( "bg_ammo" )
   bgs.heat = tex_open( "bg_heat" )
   bgs.ready = tex_open( "bg_ready" )
   bgs.shield_sm = tex_open( "bg_shield_sm" )
   bgs.armour_sm = tex_open( "bg_armour_sm" )
   bgs.energy_sm = tex_open( "bg_energy_sm" )
   bgs.speed_sm = tex_open( "bg_speed_sm" )
   sheen = tex_open( "sheen" )
   sheen_sm = tex_open( "sheen_sm" )
   sheen_weapon = tex_open( "sheen_weapon" )
   sheen_tiny = tex_open( "sheen_tiny" )
   bottom_bar = tex_open( "bottombar" )
   target_dir = tex_open( "dir", 6, 6 )
   warnlight1 = tex_open( "warnlight1" )
   warnlight2 = tex_open( "warnlight2" )
   warnlight3 = tex_open( "warnlight3" )
   warnlight4 = tex_open( "warnlight4" )
   warnlight5 = tex_open( "warnlight5" )
   tracking_light = shader_open( "track.frag" )
   target_light_off = tex_open( "targeted_off" )
   target_light_on =  tex_open( "targeted_on" )
   scan_icon = shader_open( "scan.frag" )
   scandone_icon = shader_open( "scandone.frag" )
   cargo_light_off = tex_open( "cargo_off" )
   cargo_light_on =  tex_open( "cargo_on" )
   ...
   -- Active outfit list.
   slot        = tex_open( "slot" )
   slotframe   = tex_open( "slot_frame" )
   slotend     = tex_open( "slotend" )
   cooldown    = tex_open( "cooldown", 6, 6 )
   active      = tex_open( "active" )
   ...
   -- Cooldown pane.
   cooldown_sheen = tex_open( "cooldown-sheen" )
   cooldown_bg = tex_open( "cooldown-bg" )
   cooldown_frame = tex_open( "cooldown-frame" )
   cooldown_panel = tex_open( "cooldown-panel" )
   ...
   --Messages
   gui.mesgInit( math.min( screen_w - 400, 725 ), 14, 28+10 )
