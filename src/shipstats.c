...
static const ShipStatsLookup ss_lookup[] = {
   ...
   A__ELEM( SS_TYPE_A_THRUST,             thrust,              gettext_noop("kN/tonne Thrust") ),
   A__ELEM( SS_TYPE_A_TURN,               turn,                gettext_noop("deg/s Turn Rate") ),
   A__ELEM( SS_TYPE_A_SPEED,              speed,               gettext_noop("m/s Maximum Speed") ),
   A__ELEM( SS_TYPE_A_ENERGY,             energy,              gettext_noop("MJ Energy Capacity") ),
   A__ELEM( SS_TYPE_A_ENERGY_REGEN,       energy_regen,        gettext_noop("MW Energy Regeneration") ),
   AI_ELEM( SS_TYPE_A_ENERGY_REGEN_MALUS, energy_regen_malus,  gettext_noop("MW Energy Usage") ),
   AI_ELEM( SS_TYPE_A_ENERGY_LOSS,        energy_loss,         gettext_noop("MW Energy Usage") ),
   A__ELEM( SS_TYPE_A_SHIELD,             shield,              gettext_noop("MJ Shield Capacity") ),
   A__ELEM( SS_TYPE_A_SHIELD_REGEN,       shield_regen,        gettext_noop("MW Shield Regeneration") ),
   AI_ELEM( SS_TYPE_A_SHIELD_REGEN_MALUS, shield_regen_malus,  gettext_noop("MW Shield Usage") ),
   A__ELEM( SS_TYPE_A_ARMOUR,             armour,              gettext_noop("MJ Armour") ),
   A__ELEM( SS_TYPE_A_ARMOUR_REGEN,       armour_regen,        gettext_noop("MW Armour Regeneration") ),
   AI_ELEM( SS_TYPE_A_ARMOUR_REGEN_MALUS, armour_regen_malus,  gettext_noop("MW Armour Damage") ),
   ...
   B__ELEM( SS_TYPE_I_HIDDEN_JUMP_DETECT, misc_hidden_jump_detect, gettext_noop("Hidden Jump Detection") ),
   I__ELEM( SS_TYPE_I_FUEL,               fuel,                gettext_noop("units Fuel") ),
   I__ELEM( SS_TYPE_I_CARGO,              cargo,               gettext_noop("tonnes Cargo Space") ),
