...
static const ShipStatsLookup ss_lookup[] = {
   ...
   AI_ELEM( SS_TYPE_A_ENERGY_REGEN_MALUS, energy_regen_malus,  gettext_noop("Energy Usage") ),
   AI_ELEM( SS_TYPE_A_ENERGY_LOSS,        energy_loss,         gettext_noop("Energy Usage") ),
   A__ELEM( SS_TYPE_A_SHIELD,             shield,              gettext_noop("Shield Capacity") ),
   A__ELEM( SS_TYPE_A_SHIELD_REGEN,       shield_regen,        gettext_noop("Shield Per Second") ),
   AI_ELEM( SS_TYPE_A_SHIELD_REGEN_MALUS, shield_regen_malus,  gettext_noop("Shield Usage") ),
