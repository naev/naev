...
#include "ntime.h"
#include "nstring.h"
int shiplog_create( const char *idstr, const char *logname, const char *type, int overwrite ); /* returns a log ID, for log with specified title.  If overwrite set, and title already exists, the log will be cleared and previous log ID returned, otherwise a new log ID will be created. */
