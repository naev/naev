...
#define xmlr_attr_int_def(n,s,a,def)     do {xmlr_attr(n,s,char*T); a = T==NULL ? def : strtol(  T, NULL, 10); free(T);} while(0)
#define xmlr_attr_uint_def(n,s,a,def)    do {xmlr_attr(n,s,char*T); a = T==NULL ? def : strtoul( T, NULL, 10); free(T);} while(0)
#define xmlr_attr_long_def(n,s,a,def)    do {xmlr_attr(n,s,char*T); a = T==NULL ? def : strtoll( T, NULL, 10); free(T);} while(0)
#define xmlr_attr_ulong_def(n,s,a,def)   do {xmlr_attr(n,s,char*T); a = T==NULL ? def : strtoull(T, NULL, 10); free(T);} while(0)
#define xmlr_attr_float_def(n,s,a,def)   do {xmlr_attr(n,s,char*T); a = T==NULL ? def :     atof(T          ); free(T);} while(0)
