...
/*
    ...
    OpenGL loader generated by glad 0.1.36 on Fri Dec 13 11:09:40 2024.
   ...
   --local-files
   --extensions="GL_ARB_shader_subroutine,GL_ARB_texture_filter_anisotropic,GL_KHR_debug"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D3.3&extensions=GL_ARB_shader_subroutine&extensions=GL_ARB_texture_filter_anisotropic&extensions=GL_KHR_debug
*/
...
static int open_gl( void )
{
   ...
   for ( index = 0; index < ( sizeof( NAMES ) / sizeof( NAMES[0] ) );
         index++ ) {
