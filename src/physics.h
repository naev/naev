 ...
 */
 //I would prefer thease to be static members of Solid and set in .c but im moor c++ than c and arnt sure if/how you would do it
#define AVERAGE_VELOCITY_MOD 8.0
#define AVERAGE_VELOCITY_TIME 1.12
