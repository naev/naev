...
impl Efx {
   ...
   pub fn init(device: &al::Device) -> Result<()> {
      ...
      let alAuxiliaryEffectSloti = proc_address!(c"alAuxiliaryEffectSloti", ALAUXILIARYEFFECTSLOTI);
      let alAuxiliaryEffectSlotiv =
         proc_address!(c"alAuxiliaryEffectSlotiv", ALAUXILIARYEFFECTSLOTIV);
      let alAuxiliaryEffectSlotf = proc_address!(c"alAuxiliaryEffectSlotf", ALAUXILIARYEFFECTSLOTF);
