...
int escorts_attack( Pilot *parent )
{
   ...
   if ((ret == 0) && (parent == player.p))
      player_message(_("\egEscorts: \e0Attacking %s."), t->name);
   return ret;
}
/**
...
int escorts_hold( Pilot *parent )
{
   ...
   if ((ret == 0) && (parent == player.p))
         player_message(_("\egEscorts: \e0Holding position."));
   return ret;
}
/**
...
int escorts_return( Pilot *parent )
{
   ...
   if ((ret == 0) && (parent == player.p))
      player_message(_("\egEscorts: \e0Returning to ship."));
   return ret;
}
/**
...
int escorts_clear( Pilot *parent )
{
   ...
   if ((ret == 0) && (parent == player.p))
      player_message(_("\egEscorts: \e0Clearing orders."));
   return ret;
}
...
int escorts_jump( Pilot *parent )
{
   ...
   if ((ret == 0) && (parent == player.p))
      player_message(_("\egEscorts: \e0Jumping."));
   return ret;
}
