...
#define COMMODITY_FLAG_ALWAYS_CAN_SELL (1<<1)   /**< Commodity is always sellable, even when not available normally at a spob. */
#define COMMODITY_FLAG_PRICE_CONSTANT  (1<<2)   /**< Commodity price is always constant. */
