 ...
 *    @luatparam System|nil extent Whether to make the faction hit local at a system,
 ...
 *    @luatparam[opt=false] boolean dont_propagate Whether or not the hit should affect
