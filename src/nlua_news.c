...
static const luaL_Reg news_methods[] = {
   ...
   { "__eq", newsL_eq },   { 0, 0 } }; /**< News metatable methods. */
 ...
 *    @luatparam[opt] number|Time date What time to put, defaults to current
 * date, use 0 to not use a date
 *    @luatparam[opt=5] number Priority to use. Lower is more important and will
 * appear first.
 ...
 *
 *    @luatparam[opt] number|String characteristic characteristic to match, or
 * no parameter for all articles
