 ...
 *    @luareturn A table with slot properties string "size", string "type",
 * string "property", boolean "required", boolean "exclusive", and boolean
 * "locked". (Strings are English.)
 * @luafunc slot
 */
static int poL_slot( lua_State *L )
{
