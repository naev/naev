...
void input_setDefault ( int wasd )
{
   ...
   input_setKeybind( "e_attack", KEYBIND_KEYBOARD, SDLK_END, NMOD_ALL );
   input_setKeybind( "e_hold", KEYBIND_KEYBOARD, SDLK_INSERT, NMOD_ALL );
   input_setKeybind( "e_return", KEYBIND_KEYBOARD, SDLK_DELETE, NMOD_ALL );
   input_setKeybind( "e_clear", KEYBIND_KEYBOARD, SDLK_HOME, NMOD_ALL );
   /* Space Navigation */
