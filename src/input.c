...
const char *keybind_info[][3] = {
   /* Movement */
   { "accel", p_("keybinding","Accelerate"), N_("Makes your ship accelerate forward.") },
   { "left", p_("keybinding","Turn Left"), N_("Makes your ship turn left.") },
   { "right", p_("keybinding","Turn Right"), N_("Makes your ship turn right.") },
   { "reverse", p_("keybinding","Reverse"), N_("Makes your ship face the direction you're moving from. Useful for braking.") },
   { "stealth", p_("keybinding","Stealth"), N_("Tries to enter stealth mode.") },
   /* Targeting */
   { "target_next", p_("keybinding","Target Next"), N_("Cycles through ship targets.") },
   { "target_prev", p_("keybinding","Target Previous"), N_("Cycles backwards through ship targets.") },
   { "target_nearest", p_("keybinding","Target Nearest"), N_("Targets the nearest non-disabled ship.") },
   { "target_nextHostile", p_("keybinding","Target Next Hostile"), N_("Cycles through hostile ship targets.") },
   { "target_prevHostile", p_("keybinding","Target Previous Hostile"), N_("Cycles backwards through hostile ship targets.") },
   { "target_hostile", p_("keybinding","Target Nearest Hostile"), N_("Targets the nearest hostile ship.") },
   { "target_clear", p_("keybinding","Clear Target"), N_("Clears the currently-targeted ship, spob or jump point.") },
   /* Fighting */
   { "primary", p_("keybinding","Fire Primary Weapon"), N_("Fires primary weapons.") },
   { "face", p_("keybinding","Face Target"), N_("Faces the targeted ship if one is targeted, otherwise faces targeted spob or jump point.") },
   /* Secondary Weapons */
   { "secondary", p_("keybinding","Fire Secondary Weapon"), N_("Fires secondary weapons.") },
   { "weapset1", p_("keybinding","Weapon Set 1"), N_("Activates weapon set 1.") },
   { "weapset2", p_("keybinding","Weapon Set 2"), N_("Activates weapon set 2.") },
   { "weapset3", p_("keybinding","Weapon Set 3"), N_("Activates weapon set 3.") },
   { "weapset4", p_("keybinding","Weapon Set 4"), N_("Activates weapon set 4.") },
   { "weapset5", p_("keybinding","Weapon Set 5"), N_("Activates weapon set 5.") },
   { "weapset6", p_("keybinding","Weapon Set 6"), N_("Activates weapon set 6.") },
   { "weapset7", p_("keybinding","Weapon Set 7"), N_("Activates weapon set 7.") },
   { "weapset8", p_("keybinding","Weapon Set 8"), N_("Activates weapon set 8.") },
   { "weapset9", p_("keybinding","Weapon Set 9"), N_("Activates weapon set 9.") },
   { "weapset0", p_("keybinding","Weapon Set 0"), N_("Activates weapon set 0.") },
   /* Escorts */
   { "e_targetNext", p_("keybinding","Target Next Escort"), N_("Cycles through your escorts.") },
   { "e_targetPrev", p_("keybinding","Target Previous Escort"), N_("Cycles backwards through your escorts.") },
   { "e_attack", p_("keybinding","Escort Attack Command"), N_("Orders escorts to attack your target.") },
   { "e_hold", p_("keybinding","Escort Hold Command"), N_("Orders escorts to hold their formation.") },
   { "e_return", p_("keybinding","Escort Return Command"), N_("Orders escorts to return to your ship hangars.") },
   { "e_clear", p_("keybinding","Escort Clear Commands"), N_("Clears your escorts of commands.") },
   /* Space Navigation */
   { "autonav", p_("keybinding","Autonavigation On"), N_("Initializes the autonavigation system.") },
   { "target_spob", p_("keybinding","Target Spob"), N_("Cycles through space object targets.") },
   { "approach", p_("keybinding","Approach"), N_("Attempts to approach the targeted ship or space object, or targets the nearest landable space object. Requests landing permission if necessary. Prioritizes ships over space objects.") },
   { "thyperspace", p_("keybinding","Target Jump Point"), N_("Cycles through jump points.") },
   { "starmap", p_("keybinding","Star Map"), N_("Opens the star map.") },
   { "jump", p_("keybinding","Initiate Jump"), N_("Attempts to jump via a jump point.") },
   { "overlay", p_("keybinding","Overlay Map"), N_("Opens the in-system overlay map.") },
   { "mousefly", p_("keybinding","Mouse Flight"), N_("Toggles mouse flying.") },
   { "cooldown", p_("keybinding","Active Cooldown"), N_("Begins active cooldown.") },
   /* Communication */
   { "log_up", p_("keybinding","Log Scroll Up"), N_("Scrolls the log upwards.") },
   { "log_down", p_("keybinding","Log Scroll Down"), N_("Scrolls the log downwards.") },
   { "hail", p_("keybinding","Hail Target"), N_("Attempts to initialize communication with the targeted ship.") },
   { "autohail", p_("keybinding","Autohail"), N_("Automatically initialize communication with a ship that is hailing you.") },
   /* Misc. */
   { "mapzoomin", p_("keybinding","Radar Zoom In"), N_("Zooms in on the radar.") },
   { "mapzoomout", p_("keybinding","Radar Zoom Out"), N_("Zooms out on the radar.") },
   { "screenshot", p_("keybinding","Screenshot"), N_("Takes a screenshot.") },
   { "togglefullscreen", p_("keybinding","Toggle Fullscreen"), N_("Toggles between windowed and fullscreen mode.") },
   { "pause", p_("keybinding","Pause"), N_("Pauses the game.") },
   { "speed", p_("keybinding","Toggle Speed"), N_("Toggles speed modifier.") },
   { "menu", p_("keybinding","Small Menu"), N_("Opens the small in-game menu.") },
   { "info", p_("keybinding","Information Menu"), N_("Opens the information menu.") },
   { "console", p_("keybinding","Lua Console"), N_("Opens the Lua console.") },
   { "switchtab1", p_("keybinding","Switch Tab 1"), N_("Switches to tab 1.") },
   { "switchtab2", p_("keybinding","Switch Tab 2"), N_("Switches to tab 2.") },
   { "switchtab3", p_("keybinding","Switch Tab 3"), N_("Switches to tab 3.") },
   { "switchtab4", p_("keybinding","Switch Tab 4"), N_("Switches to tab 4.") },
   { "switchtab5", p_("keybinding","Switch Tab 5"), N_("Switches to tab 5.") },
   { "switchtab6", p_("keybinding","Switch Tab 6"), N_("Switches to tab 6.") },
   { "switchtab7", p_("keybinding","Switch Tab 7"), N_("Switches to tab 7.") },
   { "switchtab8", p_("keybinding","Switch Tab 8"), N_("Switches to tab 8.") },
   { "switchtab9", p_("keybinding","Switch Tab 9"), N_("Switches to tab 9.") },
   { "switchtab0", p_("keybinding","Switch Tab 0"), N_("Switches to tab 0.") },
   /* Console-main. */
   { "paste", p_("keybinding","Paste"), N_("Paste from the operating system's clipboard.") },
