...
#define SPOB_GFX_EXTERIOR_PATH                                                 \
   "gfx/spob/exterior/" /**< Location of spob exterior graphics (when landed). \
                         */
#define SPOB_GFX_COMM_PATH                                                     \
   "gfx/spob/comm/"     /**< Location of spob communication graphics (when     \
                           hailed). */
#define GFX_PATH "gfx/" /**< Location of the graphics root. */
#define OVERLAY_GFX_PATH                                                       \
   "gfx/overlays/" /**< Location of overlays such as those used with graphics  \
                      and ships. */
#define GUI_GFX_PATH "gfx/gui/" /**< Location of the GUI graphics. */
#define PORTRAIT_GFX_PATH                                                      \
   "gfx/portraits/"                   /**< Location of the portrait graphics. */
...
#define COMMODITY_GFX_PATH                                                     \
   "gfx/commodity/" /**< Path to commodities graphics. */
...
#define ASTEROID_POLYGON_PATH                                                  \
   "gfx/spob/space/asteroid_polygon/" /**< Path to asteroid collision polygon. \
                                       */
...
#define ASTEROID_TYPES_DATA_PATH                                               \
   "asteroids/types/" /**< Asteroid types XML file location path. */
#define ASTEROID_GROUPS_DATA_PATH                                              \
   "asteroids/groups/" /**< Asteroid groups XML file location path. */
#define MAP_DECORATOR_DATA_PATH                                                \
   "map_decorator/"               /**< Where the map has background images. */
...
#define LOADSCREEN_DATA_PATH                                                   \
   "loadscreen.lua" /**< Script for the load screen. */
...
/* Currently our fonts/Cabin-SemiBold.otf lacks many fairly standard glyphs, so
 * we are falling back to the monospace font which has better coverage.
...
#define FONT_DEFAULT_PATH                                                      \
   N_( "Cabin-SemiBold.otf,NanumBarunGothicBold.ttf,SourceCodePro-Semibold."   \
       "ttf,IBMPlexSansJP-Medium.otf" ) /**< Default font path. */
#define FONT_MONOSPACE_PATH                                                    \
   N_( "SourceCodePro-Semibold.ttf,D2CodingBold.ttf,IBMPlexSansJP-Medium."     \
       "otf" ) /**< Default monospace font path. */
