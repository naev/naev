...
typedef struct WidgetCustData_ {
   ...
   void (*mouse) (unsigned int wid, SDL_Event* event, double bx, double by, double bw, double bh, void* data); /**< Function to run when receiving mouse events. */
...
void window_addCust( const unsigned int wid,
      ...
      void (*mouse) (unsigned int wid, SDL_Event* event, double x, double y, double w, double h, void* data),
      void *data );
