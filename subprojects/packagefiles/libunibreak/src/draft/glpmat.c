...
#if HAVE_SUITESPARSE_AMD_H
#include <suitesparse/amd.h>
#else /* HAVE_SUITESPARSE_AMD_H */
#include <amd.h>
#endif /* HAVE_SUITESPARSE_AMD_H */

#if HAVE_SUITESPARSE_COLAMD_H
#include <suitesparse/colamd.h>
#else /* HAVE_SUITESPARSE_COLAMD_H*/
#include <colamd.h>
#endif /* HAVE_SUITESPARSE_COLAMD_H*/
