...
local STANDARD = "+naev+var+spob+system+jump+time+player" .. PILOT .. "+rnd+diff+faction+collide+vec2+outfit+commodity+news+shiplog+file+data+linopt+safelanes+spfx+audio+audiodata"
...
files["dat/missions/**/*.lua"].std = STANDARD .. "+API_misn+misn+hook+camera+tex+bkg+music+munition" .. TK
...
files["dat/rep.lua"].std = STANDARD .. TK .. "+tex+colour+bkg+camera+music+linopt"
