\documentclass{naev}
\usepackage[rawAttribute=true,hybrid=false,pipeTables=true,tableCaptions=true,smartEllipses=true,fencedCode=true,codeSpans=true]{markdown}
...
\part{Naev ``Sea of Darkness'' Lore \naev}
