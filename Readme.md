...
have been generated by an LLM, diffusion model, or other fully-automated
...
Artificial Intelligence (AI) or **Generative AI**. Examples of products
that fit this definition: Stable Diffusion, Copilot, ChatGPT, Claude,
DeepSeek, Llama, and Gemini.

There's a distinction between general and narrow AI, all the
aforementioned examples fall under general AI as they were not trained to
execute a specific well-defined task. Narrow AI is trained to be used for
specific well-defined tasks where the problem space is known in advance,
e.g., machine translation. For the purpose of this text we do not consider
narrow AI to be an AI tool.
...
Besides the ethical, ecological, and social issues with such technologies,
the rationale behind this policy is that automated contributions are a
waste of the maintainers' time. Humans spend their time and brainpower
reviewing every submission. Issues, pull requests, or artwork generated by
automation tools create an imbalance of effort between the submitter and
the reviewer. Nobody learns anything when a maintainer reviews code or
content written by Generative AI.
