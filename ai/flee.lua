...
Mission specific AI to make pilots leave the system immediately.
  ...
  Settings
--]]
armour_run     = 100 -- At which damage to run at
armour_return  = 0 -- At which armour to return to combat
shield_run     = 100 -- At which shield to run
shield_return  = 0 -- At which shield to return to combat
aggressive     = false -- Should pilot actively attack enemies?
safe_distance  = 0 -- Safe distance from enemies to jump
land_planet    = false -- Should land on planets?
